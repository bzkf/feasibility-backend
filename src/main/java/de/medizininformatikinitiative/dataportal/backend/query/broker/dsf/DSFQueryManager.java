...
class DSFQueryManager implements QueryManager {
  ...
  private static final String INSTANTIATE_CANONICAL = "http://medizininformatik-initiative.de/bpe/Process/feasibilityRequest|1.1";
  private static final String REQUEST_PROFILE = "http://medizininformatik-initiative.de/fhir/StructureDefinition/feasibility-task-request|1.1";
  private static final String MEASURE_PROFILE = "http://medizininformatik-initiative.de/fhir/StructureDefinition/feasibility-measure|1.1";
  private static final String LIBRARY_PROFILE = "http://medizininformatik-initiative.de/fhir/StructureDefinition/feasibility-library|1.1";
